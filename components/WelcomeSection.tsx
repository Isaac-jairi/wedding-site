        ...
        <Card className="overflow-hidden border-none shadow-xl [box-shadow:0_-4px_6px_-1px_rgba(0,0,0,0.1),0_4px_6px_-1px_rgba(0,0,0,0.1)]">
          <CardContent className="p-6 md:p-10">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <p className="text-4xl md:text-5xl mb-4 font-tangerine">Queridos amigos e familiares, sejam bem-vindos ao nosso site de casamento! </p>
                <p className="text-lg md:text-xl  max-w-2xl font-cormorant">
                    ...
                    <br/>
                    Cheguem às 15h para se acomodarem e tirarem muitas fotos, pois a partir das 15h30 daremos início à cerimônia! 

                    Seremos pontuais!
                    <br/>
                    <br/>
                    Para confirmação de presença, basta nos enviar uma mensagem no WhatsApp. Iremos falar com cada um de vocês de maneira individual e personalizada! 

                    Lembrando que essa confirmação é muitíssimo importante!
                    <br/>
                    <br/>
